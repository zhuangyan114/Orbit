...
#ifndef P_TOKENIZER_CFG_ARG_TYPES_SIZE_BYTES
#define P_TOKENIZER_CFG_ARG_TYPES_SIZE_BYTES 4
...
/// value hash to the same value. Increasing `P_TOKENIZER_CFG_C_HASH_LENGTH`
/// increases the compilation time for C due to the complexity of the hashing
/// macros.
///
/// `P_TOKENIZER_CFG_C_HASH_LENGTH` has no effect on C++ code. In C++, hashing
...
#ifndef P_TOKENIZER_CFG_C_HASH_LENGTH
#define P_TOKENIZER_CFG_C_HASH_LENGTH 128
#endif  // P_TOKENIZER_CFG_C_HASH_LENGTH

/// `P_TOKENIZER_CFG_ENCODING_BUFFER_SIZE_BYTES` is deprecated. It is used as
/// the default value for pw_log_tokenized's
/// `P_LOG_TOKENIZED_ENCODING_BUFFER_SIZE_BYTES`. This value should not
/// be configured; set `P_LOG_TOKENIZED_ENCODING_BUFFER_SIZE_BYTES`
/// instead.
#ifndef P_TOKENIZER_CFG_ENCODING_BUFFER_SIZE_BYTES
#define P_TOKENIZER_CFG_ENCODING_BUFFER_SIZE_BYTES 52
#endif  // P_TOKENIZER_CFG_ENCODING_BUFFER_SIZE_BYTES
...
/// concatenation.
#ifndef P_TOKENIZER_NESTED_PREFIX_STR
#define P_TOKENIZER_NESTED_PREFIX_STR "$"
#endif  // P_TOKENIZER_NESTED_PREFIX_STR
