...
Acceptance: Node, Python, and PowerShell clients generated from OpenRPC produce identical JSON-RPC contexts, decode OperationResult/error envelopes, retain exact numeric strings, decode Base64, and follow pagination.
