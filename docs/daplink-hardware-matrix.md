...
> **收口说明（2026-08-11）**：本文件保留 DAP-00 当时的条件通过、未知项和阻塞现场，不再代表项目当前状态。后续阶段已经完成 helper、DP/AP、Flash Algorithm、调试控制和上层功能；当前能力与限制以 [README](../README.md) 和 [用户指南](../Releases/docs/user-guide.md) 为准。
