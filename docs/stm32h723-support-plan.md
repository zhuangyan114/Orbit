...
- P7-6/7 复用 `scripts/automation-api/verify-hardware.js --board STM32H723VGT6` 与既有 dap09/dap10 家族脚本。
...
- 硬件验收完成第 1–5 级(第 6 级 J-Link、第 7 级长稳可随后补),证据 JSON 存 `outputs/`,并按仓库规则仅在用户确认后写 `docs/bug-fix-log.md`。
